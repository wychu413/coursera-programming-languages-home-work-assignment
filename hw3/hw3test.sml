...
val test1_2 = only_capitals ["Abc", "Bcd", "cdef"] = ["Abc", "Bcd"];

val test2_1 = longest_string1 ["A","bc","C"] = "bc";
val test2_2 = longest_string1 ["A", "AB", "bc", "C"] = "AB";

val test3_1 = longest_string2 ["A","bc","C"] = "bc";
val test3_2 = longest_string2 ["A", "AB", "bc", "cd", "C"] = "cd";

val test4a_1 = longest_string3 ["A","bc","C"] = "bc";
val test4a_2 = longest_string3 ["A", "AB", "bc", "C"] = "AB";
